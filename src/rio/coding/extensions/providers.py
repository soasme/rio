...
from rio.ai.types import JSONPrimitive, JSONValue
from rio.coding.provider_catalog import ModelInput, ProviderApi
...
class RequiredApiKey:
    """Resolve a required API key from rio credentials, then the environment."""
...
class OpenAICompatibleTransport:
    """Descriptor for rio's existing OpenAI-compatible streaming transport.
    ...
    lifetime. Normal transports leave it unset and use rio's standard client.
    """
