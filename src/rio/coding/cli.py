...
from rio.coding.auth_commands import login_provider, logout_provider
from rio.coding.catalog_loader import user_catalog_path
from rio.coding.credentials import FileCredentialStore
from rio.coding.extension_installer import ExtensionInstallError, install_extension
...
from rio.coding.provider_runtime import DeferredModelProvider, create_model_provider
from rio.coding.rendering import PrintOutputMode, create_event_renderer
...
from rio.coding.session_manager import CodingSessionRecord, SessionManager, validate_session_id
...
from rio.coding.updater import update_rio
    ...
    *,
    ...
    try:
        ...
        if mode == "rpc":
            ...
            return True
        if mode == "tui":
            from rio.tui import run_tui_app
