...
from rio.coding.events import AutoRetryStartEvent, QueueUpdateEvent, SessionRunEndEvent
from rio.coding.session_store import StepEntry, TurnEntry, latest_leaf_id, path_to_entry
from rio.tui.bridge import SessionBridge
from rio.tui.commands import ACTIONS, BUILTIN, help_message
from rio.tui.dialogs import Changes, FilePicker, Picker, Preferences
from rio.tui.widget_conversation import (
    Answer,
    Conversation,
    Notice,
    Thought,
...
from rio.tui.widget_prompt import Editor, Prompt
from rio.tui.widget_sidebar import Plan, Sidebar
...
class SessionScreen(Screen):
    ...
    async def command(self, text):
        ...
        try:
            if name in {"quit", "exit"}:
                ...
                from rio.coding.auth_commands import logout_provider
                ...
                if result and result.handled:
                    ...
                    if result.export_requested:
                        from rio.coding.session_export import export_session_artifact
    ...
    async def login(self, provider):
        ...
        from rio.coding.oauth_types import OAuthLoginCallbacks
