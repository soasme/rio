"""Run with ``uv run python src/rio_coding/data/examples/offline_session.py``."""

import asyncio
from pathlib import Path

from rio_ai import AssistantDoneEvent, AssistantMessage, FakeProvider, ToolCall
from rio_coding import CodingSession, CodingSessionConfig
from rio_coding.rendering import PlainEventRenderer
