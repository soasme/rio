...
from rio_agent import HarnessCancellationToken
        ...
        *,
        ...
        if operation is None:
            ...
            task = asyncio.create_task(
                ...
                name=f"rio-provider-refresh:{token.source_id}:{provider_id}",
            )
        ...
        *,
        ...
        try:
            callback_task = asyncio.create_task(
                ...
                name=f"rio-provider-discovery:{token.source_id}:{token.provider_id}",
            )
