...
from rio_coding.thinking import THINKING_LEVELS, ThinkingLevel
...
if TYPE_CHECKING:
    ...
    # dependent.
    from rio_coding.provider_catalog import ProviderCatalogEntry
...
def bundled_models_dev_catalog_document() -> dict[str, Any] | None:
    ...
    try:
        text = files("rio_coding").joinpath(MODELS_DEV_CATALOG_RESOURCE).read_text(encoding="utf-8")
