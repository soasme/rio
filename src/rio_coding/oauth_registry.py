...
from rio_coding.oauth import OpenAICodexOAuthProvider
from rio_coding.oauth_anthropic import AnthropicOAuthProvider
from rio_coding.oauth_github_copilot import GitHubCopilotOAuthProvider
...
def oauth_provider_ids() -> frozenset[str]:
    """Return IDs accepted by rio's subscription login flow."""
