"""Best-effort terminal attention notifications for completed Rio turns."""
...
from rio_coding.tui.config import TurnNotificationMode
from rio_coding.tui.terminal_title import sanitize_terminal_title

OSC_TERMINATOR = "\a"
TURN_FINISHED_MESSAGE = "Rio turn finished"
...
def terminal_notification_supported(
    *,
    ...
    """Return whether Rio may write attention sequences to this terminal."""
