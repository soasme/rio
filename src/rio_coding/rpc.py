...
and nothing to compact (see `rio_coding.session` and `rio_coding.step_footprint`
...
now project `rio_coding.session_store` state-journal entries (turns, steps,
...
from rio_coding.events import CodingSessionEvent, EntryAppendedEvent
...
from rio_coding.thinking import THINKING_LEVELS, next_thinking_level
