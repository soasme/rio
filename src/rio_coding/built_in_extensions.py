...
from rio_coding.credentials import CredentialStore
from rio_coding.paths import RioPaths

if TYPE_CHECKING:
    from rio_coding.extensions.api import ExtensionAPI
...
def _llama_cpp_setup(api: ExtensionAPI) -> None:
    ...
    from rio_coding.extensions.builtins.llama_cpp import setup
