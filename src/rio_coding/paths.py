"""Canonical filesystem paths for rio user and project data."""
...
class RioPaths:
    """Resolved rio filesystem locations.

    rio keeps durable application data under the user's home directory while also
    loading project-local resources from the active working directory.
    """

    home: Path = field(default_factory=lambda: Path.home() / ".rio")
    ...
    def logs_dir(self) -> Path:
        """Return rio's user-level diagnostic log directory."""
    ...
    def user_skills_dir(self) -> Path:
        """Return rio's user-level skills directory."""
        return self.home / "skills"

    @property
    def user_prompts_dir(self) -> Path:
        """Return rio's user-level prompt templates directory."""
        return self.home / "prompts"

    @property
    def user_themes_dir(self) -> Path:
        """Return rio's user-level TUI themes directory."""
        return self.home / "themes"

    @property
    def user_extensions_dir(self) -> Path:
        """Return rio's user-level extension directory."""
    ...
    def project_rio_dir(self, cwd: Path) -> Path:
        """Return the project-local rio resource directory."""
        return cwd / ".rio"
    ...
    def project_skills_dir(self, cwd: Path) -> Path:
        """Return the project-local rio skills directory."""
        return self.project_rio_dir(cwd) / "skills"

    def project_prompts_dir(self, cwd: Path) -> Path:
        """Return the project-local rio prompt templates directory."""
        return self.project_rio_dir(cwd) / "prompts"
